# AGENTS.md — herenow-api

> This file is the agent contract for the `herenow-api` service.
...
```bash
# From the repo root
docker compose -f infra/docker-compose.yml up -d herenow-api-db
...
# Python
uv sync && uv run python -m herenow-api
...
This service's data types are defined in `packages/schema/proto/herenow-api/v1/`.
...
# TypeScript:  import { User, UserStatus } from '@schema/herenow-api/v1/...'
# Go:          import "[module]/packages/schema/generated/go/herenow-api/v1"
# Python:      from schema.herenow-api.v1 import User, UserStatus
# Rust:        mod proto { include!(concat!(env!("OUT_DIR"), "/herenow-api.v1.rs")); }
```

If you need a new type:

1. Add it to `packages/schema/proto/herenow-api/v1/`
